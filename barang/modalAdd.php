        ...
        <div class="row" style="font-weight: bold;">
          <div class="col-lg-12">
            <div class="form-group">
              ...
              <input style="background-color: #CBCBCB; color: black; font-size: 18px;" class="form-control"  id="nama" name="nama" autofocus required form="formaddbarang">
            </div>
            <div class="form-group">
              <h5 for="hargabeli">Harga Beli</h5>
              <input style="background-color: #CBCBCB; color: black; font-size: 18px;" type="text" class="form-control"  id="hargabeli" name="hargabeli" required form="formaddbarang">
            </div>
            <div class="form-group">
              <h5 for="hargajual">Harga Jual</h5>
              <input style="background-color: #CBCBCB; color: black; font-size: 18px;" type="text" class="form-control"  id="hargajual" name="hargajual" required form="formaddbarang">
            </div>
