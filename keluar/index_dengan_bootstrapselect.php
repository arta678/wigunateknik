...
<body>
    <div id="wrapper">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            ...
                            <div class="form-group ">
                                ...
                                <select  class="form-control selectpicker" data-live-search="true" data-size="5" name="barang[]"  id="barang" title="Cari Barang" data-focus-off="true">
                                    <?php 
                                    ...
                                    while ( $row = mysqli_fetch_array($hasil) ) { ?>
                                        <option data-tokens="<?= $row['namakategori']; ?>" value="<?= $row['idbarang'] ?>" data-stok="<?=  $row['stokbarang']; ?>" data-harga="<?=  $row['hargabeli']; ?>" data-namabarang="<?=  $row['namabarang']; ?>" data-kategori="<?=  $row['namakategori']; ?>"  ><?= $row['namabarang']; ?></option>
                                        <?php 
                                    }
                                    ?>
                                </select>
        ...
        <script type="text/javascript" src="../asset/scripts/bootstrap-select.js"></script>
        <!-- <script type="text/javascript" src="../asset/css/bootstrap-dropdown.js"></script> -->
        <script>
            ...
            $(document).ready(function(){
                ...
                $('#tambah').click(function (e) {
                    ...
                    htm += "<td>" + '<input type="hidden" name="harga[]" form="formaddbarangmasuk" value="' + $("#harga").val() + '">'+ $("#kategori").val() +"</td>";
