                            ...
                            <div class="form-group ">
                                ...
                                <select  class="form-control" data-live-search="true" data-size="5" name="barang[]" required  id="barang" title="Pilih Barang">
                                    ...
                                    while ( $row = mysqli_fetch_array($hasil) ) { ?>
                                        <option data-lookup="<?= $row['namakategori']; ?>" value="<?= $row['idbarang'] ?>" data-stok="<?=  $row['stokbarang']; ?>" data-harga="<?=  $row['hargabeli']; ?>" data-namabarang="<?=  $row['namabarang']; ?>" data-kategori="<?=  $row['namakategori']; ?>" class="form-control col-sm-12 "><?= $row['namabarang']; ?></option>
                                        <?php 
                                    }
                                    ?>
                                </select>
