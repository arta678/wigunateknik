...
(482, 'CPT', '200000', '25000', 1, 1072),
(501, 'Bosse ', '21500', '38000', 1, 30164),
(505, 'Ellysion [Kramik]', '75', '75000', 1, 130),
...
(587, 'Bitec Volcano', '300000', '30000', 1, 325),
(590, 'GAT', '300000', '35000', 1, 252),
(592, 'Piting Gantung Broco', '3700', '6000', 110, 113),
(593, 'GT Japan', '36500', '40000', 1, 969),
...
(628, 'Dinamax Merah', '90000', '140000', 1, 53),
...
(638, 'RI-522C', '295500', '335000', 107, 4),
...
(652, 'Selang Paket Miyako RMS-206 M', '70000', '90000', 107, 49),
...
(894, 'Resibon Asab ', '10500', '15000', 1, 11),
(895, 'Kinik Asab', '6750', '9000', 1, 603),
...
(1024, 'NS 60 YUASA', '750000', '750000', 105, 19),
...
(1066, 'Quantum Paket QRL 032', '85000', '115000', 157, 12),
(1067, 'AJP HITAM 42', '2600000', '3000000', 159, 70),
(1068, 'AJP 8 inc Merah', '235000', '275000', 1, 0),
(1069, 'Quantum QRL-03', '55000', '75000', 157, 12),
(1071, 'Diton Standart Black', '18383', '22000', 161, 108),
(1072, 'Diton Standart Red', '18382', '22000', 161, 12),
(1074, 'Kabel', '47500', '200000', 1, 601),
(1075, 'Piting Broco Hitam', '3850', '6000', 162, 60),
(1076, 'Diton Standart Silver', '18383', '22000', 161, 156),
(1077, 'Diton Standart White', '18383', '22000', 161, 60),
(1078, 'Diton Standart Black Doff', '18383', '22000', 161, 36),
(1079, 'Lem Dextone 5 Minutes (Besi)', '12750', '15000', 163, 24);
...
CREATE TABLE `tbdetailtransaksi` (
  ...
  `idbarang` int(11) NOT NULL,
  `hargabeli` decimal(10,1) DEFAULT NULL,
  `jumlahbarang` int(11) NOT NULL,
  `idsatuan` int(11) NOT NULL,
  `diskon1` decimal(5,2) DEFAULT NULL,
  `diskon2` decimal(5,2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbdetailtransaksi` (`iddetailtransksi`, `idtransaksi`, `idbarang`, `hargabeli`, `jumlahbarang`, `idsatuan`, `diskon1`, `diskon2`) VALUES
(79, 'TR001', 1079, '12750.0', 24, 1, '0.00', '0.00'),
(80, 'TR002', 1076, '21500.0', 24, 6, '10.00', '5.00'),
(81, 'TR002', 1077, '21500.0', 12, 6, '10.00', '5.00'),
(82, 'TR002', 1078, '21500.0', 12, 6, '10.00', '5.00');
...
INSERT INTO `tbsatuan` (`idsatuan`, `namasatuan`, `isisatuan`) VALUES
(1, 'Pcs', 1),
(2, 'Lusin', 12),
(3, 'Dus (10)', 10),
(4, 'Kg', 1),
...
(5, 'Yuasa', 'Jl. Sekar Jepun No.2 Kesiman Kerta Langu Denpasar', '03614713484', '', '', ''),
(8, 'Pak Cosmoss', 'Denpasar', '08563880878', '', '', ''),
(9, 'AJP', 'Jakarta', '08174795079', '', '', ''),
(10, 'Pak Sujana', 'Denpasar', '087761872588', '', '', ''),
(11, 'Karya Bangun Sentosa', 'Denpasar', '085100501334', '', '', ''),
...
(21, 'Agung Mambal', 'Mambal denpasar', '', '', '', ''),
(22, 'Purnama Listrik', 'Denpasar - Bali', '085847216979', '085337823821', '', '');
...
INSERT INTO `tbtransaksi` (`idtransaksi`, `tanggal`, `tipetransaksi`, `status`, `gambar`, `ppn`, `idcustomer`, `idsuplier`) VALUES
('TR001', '2021-01-22', 'In', '0', NULL, 0, NULL, 20),
('TR002', '2021-01-22', 'In', '0', NULL, 0, NULL, 20);
...
--
ALTER TABLE `tbbarang`
  MODIFY `idbarang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1080;
--
...
--
ALTER TABLE `tbdetailtransaksi`
  MODIFY `iddetailtransksi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;
--
-- AUTO_INCREMENT for table `tbkategori`
--
ALTER TABLE `tbkategori`
  MODIFY `idkategori` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=164;
--
...
--
ALTER TABLE `tbsuplier`
  MODIFY `idsuplier` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
...
--
ALTER TABLE `tbdetailtransaksi`
  ADD CONSTRAINT `satuan` FOREIGN KEY (`idsatuan`) REFERENCES `tbsatuan` (`idsatuan`) ON DELETE CASCADE ON UPDATE CASCADE,
