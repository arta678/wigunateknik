                    ...
                    <div class="panel panel-default ">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control col-md-12" name="idsatuan" required form="formaddbarangmasuk" id="idsatuan">
                                    <?php 
                                    $input = "SELECT * FROM tbsatuan ";
                                    $hasil = mysqli_query($conn, $input);
                                    while ( $row = mysqli_fetch_array($hasil) ) { ?>
                                        <option value="<?= $row['idsatuan'] ?>"><?= $row['namasatuan']; ?></option>
                                        <?php 
                                    }
                                    ?>
                                </select>
                            ...
                            <audio id="song">
                                ...
                                <div class="form-group " id="checkboxViewDiskon">
                                    ...
                                    <label for="tampilkanDiskon">View Discount</label>
