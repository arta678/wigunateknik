<div class="modal" id="modalAddBarang"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      ...
      <div class="modal-body bg-warning">
        <div class="row" style="font-weight: bold;">
          <div class="col-lg-12">
            ...
            <button type="submit" class="btn btn-success" form="formaddbarang">Simpan</button>
            <button type="button" data-toggle="modal" data-target="#modalTambahKategori" class="btn btn-primary">Add Kategori</button>
          </div>
        </div>
      </div>
    </div>
